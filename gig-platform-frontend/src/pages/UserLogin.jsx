...
export default function UserLogin() {
  ...
  const handleSendOtp = (e) => {
    e.preventDefault();
    if (contact) setStep('verify');
  };

  const handleVerify = (e) => {
    e.preventDefault();
    // Here you will eventually add your backend verification logic
    alert(`Verifying OTP ${otp} for ${contact}`);
  };
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <h2>Client Login</h2>
        <p style={{ color: '#666', marginBottom: '20px' }}>Hire top talent for your project.</p>
